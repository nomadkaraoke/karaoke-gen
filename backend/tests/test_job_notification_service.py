...
class TestURLBuilding:
    ...
    def test_build_review_url_basic(self):
        ...
        assert url == "https://gen.nomadkaraoke.com/en/app/jobs#/job-123/review"
    ...
    def test_build_review_url_preserves_job_id_characters(self):
        ...
        assert url == "https://gen.nomadkaraoke.com/en/app/jobs#/abc-def-123/review"
    ...
    def test_build_instrumental_url_basic(self):
        ...
        assert url == "https://gen.nomadkaraoke.com/en/app/jobs#/job-123/instrumental"
...
class TestActionReminderEmail:
    ...
    async def test_send_instrumental_reminder_includes_url(self):
        ...
        assert instrumental_url == "https://gen.nomadkaraoke.com/en/app/jobs#/job-123/instrumental"
